...
## Remote Finalization Commands

After the first successful push of `development`, run:
...
Expected:
- `development` tracks `origin/development`
- remote `development` exists
- future pushes can use plain `git push`
