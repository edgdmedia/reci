...
<main class="layout-page">
       ...
       $base_url,
				...
				<div class="flex justify-start items-center gap-5 flex-wrap">
					...
					<div class="archive-filter-select-wrap">
						...
						<select id="quiz-topic-filter" name="topic" class="archive-filter-select" aria-label="Filter by topic">
    ...
    $term->slug,
          ...
          $current_search,
      ); ?>" placeholder="Search Quizzes" class="archive-filter-search-input" />
					</div>
					<?php if ($has_filters): ?>
