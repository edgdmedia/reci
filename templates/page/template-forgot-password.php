			...
			<div class="flex flex-col items-center gap-10">
				...
				<div class="flex flex-col items-center gap-3 text-center">
					<h1 class="text-3xl font-bold font-heading text-neutral-800">
						<?php echo isset( $_GET['reset'] ) && $_GET['reset'] === 'sent' ? esc_html__( 'Check Your Email', 'reci-media-hub' ) : esc_html__( 'Forgot Password', 'reci-media-hub' ); ?>
					</h1>
					<p class="text-lg font-normal text-neutral-600">
						<?php echo isset( $_GET['reset'] ) && $_GET['reset'] === 'sent' ? esc_html__( "If there's an account associated with your email, you will receive a reset link shortly.", 'reci-media-hub' ) : esc_html__( "Enter your email below and we'll send you a link to reset it.", 'reci-media-hub' ); ?>
					</p>
				</div>
