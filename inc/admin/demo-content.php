		...
		'chapters' => [
			...
			[
				...
				'props'   => [
					...
					'use_background_image' => '1',
					'background_image'     => $im( 'We Humans - Students hearing the curriculum, 1959.webp' ),
			...
			[
				...
				'props'   => [
					...
					'image'           => $im( 'We Humans - Students hearing the curriculum, 1959.webp' ),
					'media_side'      => 'right',
					'actions'         => [
				...
				'props'   => [
					...
					'items'   => [
						...
						[
							...
							'annotations' => [
								[ 'x' => '37.2', 'y' => '43.1', 'title' => 'War bonnet', 'body' => 'On the left of the panel, a Native American (identified as "Sioux Indian") war bonnet sits on the head of the "Mongoloid" mannequin. These feathered headdresses are markers of earned social status among Native peoples of the Great Plains.' ],
								[ 'x' => '53.6', 'y' => '51.0', 'title' => 'Turban', 'body' => 'In the center, the "Caucasoid" mannequin wears a turban and is identified as "Hindu." This choice was a possible allusion to the pagri, a kind of turban worn on the Indian subcontinent. It bears repeating, however, that all of the racial categorizations used by Swauger and Dragoo were based on faulty premises now rejected by science.' ],
								[ 'x' => '73.6', 'y' => '42.1', 'title' => 'Headdress from Malawi', 'body' => 'On the right, the "Negroid" mannequin wears a headdress from Malawi, a country in East Africa. While Swauger and Dragoo identify these items as coming from the Maasai people, the Maasai are not typically known to live in Malawi, thus placing this attribution into question.' ],
							],
						],
						[
					...
					'sections' => [
						[
							...
							'paragraphs' => [
								...
								[ 'text' => '<strong>Books &amp; articles</strong>' ],
								[ 'text' => 'Anthony Hazard, <em>Postwar Anti-racism: The U.S., Unesco and "Race," 1945-1968</em> (Palgrave, 2012).' ],
								[ 'text' => 'James B. Stewart, "Civil Rights and Organized Labor: The Case of the United Steelworkers of America," in <em>African Americans in the U.S. Economy</em> (Rowman and Littlefield, 2005).' ],
								[ 'text' => 'Tracy Teslow, <em>Constructing Race: The Science of Bodies and Cultures in American Anthropology</em> (Cambridge University Press, 2014).' ],
								[ 'text' => 'Joe William Trotter Jr., Jared N. Day, <em>Race and Renaissance: African Americans in Pittsburgh since World War II</em> (University of Pittsburgh Press, 2010).' ],
							],
							'links'      => [
