...
$title_classes   = $args['title_classes'] ?? "self-stretch justify-start text-neutral-800 text-6xl font-bold font-['EB_Garamond'] leading-[68.20px] line-clamp-2";
$excerpt_classes = $args['excerpt_classes'] ?? "self-stretch justify-start text-neutral-500 text-lg font-normal font-['SF_Pro_Display'] leading-7 tracking-tight";
...
<div data-layer="Content" class="Content w-full max-w-[700px] self-stretch inline-flex flex-col justify-start items-start gap-8 lg:gap-10">
    <div data-layer="Content" class="Content self-stretch flex flex-col justify-start items-start gap-5">
        <div data-layer="Content" class="Content self-stretch flex flex-col justify-start items-start gap-2">
            <div data-layer="Content" class="Content inline-flex justify-start items-center gap-2.5">
                ...
                <div data-layer="08 Jan 2026" class="Jan2026 justify-start text-neutral-500 text-base font-normal font-['SF_Pro_Display'] leading-4"><?php echo esc_html($date); ?></div>
                <div data-layer="Tag" class="Tag tag-dot"></div>
                <div data-layer="Nav Text" class="NavText flex justify-start items-center gap-0.5">
                    ...
                    <div data-layer="meta" class="Mins justify-start text-neutral-500 text-base font-normal font-['SF_Pro_Display']"><?php echo esc_html($meta_value); ?></div>
                </div>
            </div>
            <div data-layer="Content" class="Content self-stretch flex flex-col justify-start items-start gap-5">
                <?php if ($link_url) : ?>
    ...
    <?php if ($image_url) : ?>
        <?php if ($link_url) : ?>
            <a href="<?php echo esc_url($link_url); ?>" class="self-stretch flex-1 no-underline">
                <img data-layer="Image" class="Image self-stretch flex-1 p-2.5 object-cover rounded-lg" src="<?php echo esc_url($image_url); ?>" alt="<?php echo esc_attr($image_alt); ?>" />
            </a>
        <?php else : ?>
            <img data-layer="Image" class="Image self-stretch flex-1 p-2.5 object-cover rounded-lg" src="<?php echo esc_url($image_url); ?>" alt="<?php echo esc_attr($image_alt); ?>" />
        <?php endif; ?>
