...
$query_args = [
    'post_type'      => ['reci_article', 'reci_video', 'reci_podcast', 'reci_event', 'reci_reflection'],
    'post_status'    => 'publish',
    'posts_per_page' => 12,
        ...
        <div class="self-stretch pb-5 border-b border-zinc-400">
            <form method="get" action="<?php echo esc_url($base_url); ?>" class="self-stretch flex flex-col sm:flex-row justify-between items-center gap-5" data-archive-filter-form data-search-min="3" data-search-debounce="350">
                ...
                <div class="w-full sm:w-auto flex items-center gap-2.5">
                    <div class="w-full sm:w-80 px-5 py-4 bg-white rounded-lg flex justify-start items-center gap-2.5 border border-zinc-200" role="search">
                        ...
                        <input id="sphere-search" type="search" name="search" value="<?php echo esc_attr($current_search); ?>" placeholder="<?php esc_attr_e('Search', 'reci-media-hub'); ?>" class="flex-1 italic bg-transparent text-neutral-500 text-base font-light placeholder-neutral-500 focus:outline-none" />
                    </div>
                    <?php if ($has_filters): ?>
