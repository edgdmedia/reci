 ...
 * Form collects full name, email, phone, city, and password.
 *
				...
				>
					...
					<div class="flex flex-col gap-2">
						...
						<input
							...
							id="reci-fullname"
							name="reci_fullname"
							placeholder="<?php echo esc_attr__( 'John Doe', 'reci-media-hub' ); ?>"
							autocomplete="name"
					...
					<div class="flex flex-col sm:flex-row gap-5">
						...
						<div class="flex-1 flex flex-col gap-2">
							<label
								...
								class="text-sm font-medium font-['SF_Pro_Display'] text-neutral-800 leading-6"
							>
								<?php echo esc_html__( 'Phone', 'reci-media-hub' ); ?>
							</label>
							<input
								type="tel"
								id="reci-phone"
								name="reci_phone"
								placeholder="<?php echo esc_attr__( '+1 (555) 000-0000', 'reci-media-hub' ); ?>"
								autocomplete="tel"
								class="w-full px-4 py-5 rounded-lg outline outline-[0.5px] outline-zinc-400 text-sm font-normal font-['SF_Pro_Display'] text-neutral-800 placeholder-zinc-400 bg-white focus:outline-[#003594] focus:outline-2 transition-all"
							/>
						</div>
					...
					<div class="flex flex-col gap-2">
						<label
							...
							class="text-sm font-medium font-['SF_Pro_Display'] text-neutral-800 leading-6"
						>
							<?php echo esc_html__( 'City', 'reci-media-hub' ); ?>
						</label>
						<div class="relative">
							<select
								id="reci-city"
								name="reci_city"
								class="w-full appearance-none px-4 py-5 rounded-lg outline outline-[0.5px] outline-zinc-400 text-sm font-normal font-['SF_Pro_Display'] text-zinc-400 bg-white focus:outline-[#003594] focus:outline-2 transition-all"
							>
								<option value="" disabled selected><?php echo esc_html__( 'Select', 'reci-media-hub' ); ?></option>
								<option value="pittsburgh"><?php echo esc_html__( 'Pittsburgh, PA', 'reci-media-hub' ); ?></option>
								<option value="philadelphia"><?php echo esc_html__( 'Philadelphia, PA', 'reci-media-hub' ); ?></option>
								<option value="new-york"><?php echo esc_html__( 'New York, NY', 'reci-media-hub' ); ?></option>
								<option value="atlanta"><?php echo esc_html__( 'Atlanta, GA', 'reci-media-hub' ); ?></option>
								<option value="chicago"><?php echo esc_html__( 'Chicago, IL', 'reci-media-hub' ); ?></option>
								<option value="other"><?php echo esc_html__( 'Other', 'reci-media-hub' ); ?></option>
							</select>
							<!-- Chevron -->
							<div class="pointer-events-none absolute right-4 top-1/2 -translate-y-1/2 text-neutral-800">
