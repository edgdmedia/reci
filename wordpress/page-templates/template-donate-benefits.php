	...
	<section class="bg-[#003594]">
		<div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 xl:px-20 py-14 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-5 border-b border-white/20">
			...
			<p class="text-lg font-normal text-white/70 max-w-xl leading-7 tracking-tight sm:pl-10 sm:border-l sm:border-white/30">
				<?php echo esc_html__( 'See what you receive as a RECI donor. Every level of support comes with meaningful recognition and exclusive access.', 'reci-media-hub' ); ?>
			</p>
		</div>
	</section>
		...
		<div class="flex flex-col lg:flex-row gap-14 items-start">
			...
			<aside class="w-full lg:w-96 flex flex-col gap-10 shrink-0">
				...
				<div class="w-full p-10 bg-[#003594] rounded-lg flex flex-col gap-5">
					<div class="flex flex-col gap-3">
						...
						<p class="text-base font-normal font-['SF_Pro_Display'] text-blue-200 leading-6 tracking-tight">
							<?php echo esc_html__( 'Choose your giving level and start making a difference today.', 'reci-media-hub' ); ?>
						</p>
					</div>
					<a href="<?php echo esc_url( $donate_url ); ?>" class="self-start px-7 py-3.5 bg-amber-400 rounded-lg text-sm font-medium font-['SF_Pro_Display'] text-neutral-800 leading-6 hover:bg-amber-300 transition-colors">
			...
			<div class="flex-1 flex flex-col gap-8">
				...
				<div class="w-full overflow-x-auto rounded-lg border border-zinc-200">
					<table class="w-full text-sm font-['SF_Pro_Display'] border-collapse min-w-[640px]">
						<thead>
				...
				<div class="p-6 bg-blue-50 border border-blue-200 rounded-lg text-sm font-['SF_Pro_Display'] text-blue-800 leading-6">
