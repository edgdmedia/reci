...
$listing_config = [
	'post_type'                => ['reci_article', 'reci_podcast', 'reci_video', 'reci_event'],
	'posts_per_page'           => 9,
	'orderby'                  => 'date',
	'order'                    => 'DESC',
	...
	<section class="w-full bg-white border-b border-zinc-400">
		<div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 xl:px-20 py-14 flex flex-col lg:flex-row justify-between gap-6">
			<div class="flex items-center gap-3">
				...
				<h1 class="text-neutral-800 text-5xl font-medium font-['EB_Garamond']">By Location</h1>
			</div>
			<p class="max-w-xl text-neutral-500 text-lg font-normal font-['SF_Pro_Display']">Discover content tied to specific communities and geographies.</p>
		</div>
	</section>
	...
	<section class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 xl:px-20 py-6 border-b border-zinc-300">
		<form method="get" action="<?php echo esc_url($base_url); ?>" class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4" data-archive-filter-form data-search-min="3" data-search-debounce="350">
			<div class="flex items-center gap-3 w-full lg:w-auto">
				...
				<select id="location-filter" name="location" class="px-4 py-3 rounded-lg border border-zinc-300 bg-white text-neutral-800 text-base font-['SF_Pro_Display'] focus:outline-none">
			...
			<div class="flex items-center gap-2 w-full lg:w-auto">
				...
				<input id="location-search" type="search" name="search" value="<?php echo esc_attr($current_search); ?>" placeholder="Search" class="w-full lg:w-80 px-4 py-3 rounded-lg border border-zinc-300 bg-white text-neutral-700 text-base font-['SF_Pro_Display'] focus:outline-none" />
				<?php if ($has_filters) : ?>
