...
$mode_active_classes   = "flex-1 px-4 py-2 bg-amber-400 rounded-lg flex justify-center items-center gap-2 overflow-hidden text-sm font-medium font-['SF_Pro_Display'] text-neutral-800 leading-6 tracking-tight";
$mode_inactive_classes = "flex-1 px-4 py-2 rounded-lg outline outline-[0.5px] outline-neutral-500 flex justify-center items-center gap-2 overflow-hidden text-sm font-medium font-['SF_Pro_Display'] text-neutral-500 leading-5 tracking-tight hover:bg-slate-50 transition-colors";
	...
	<section class="bg-white">
		<div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 xl:px-20 py-14 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-5 border-b border-white/20">
			...
			<div class="flex items-center gap-3">
				...
				<h1 class="text-5xl font-medium font-['EB_Garamond'] leading-[1.05] text-black">
					<?php echo esc_html__('Donate', 'reci-media-hub'); ?>
				</h1>
			</div>

			<!-- Subtitle -->
			<p class="text-lg font-normal text-black/70 max-w-xl leading-7 tracking-tight sm:pl-10 sm:border-l sm:border-white/30">
				<?php echo esc_html__('Your contribution directly supports RECI\'s mission to advance racial equity through education, media, and community engagement. Every dollar helps us build a more just world.', 'reci-media-hub'); ?>
			</p>
				...
				<nav id="donate-section-nav" class="w-full p-10 bg-[#003594] rounded-lg flex flex-col gap-10 overflow-hidden" aria-label="Donation page navigation">
					...
					<a id="donate-nav-donate" href="#donation-form" class="flex flex-col gap-3 transition-opacity">
						<div class="flex items-center gap-2">
							...
							<span id="donate-nav-donate-text" class="text-white text-2xl font-bold font-['EB_Garamond'] leading-7">
								<?php echo esc_html__('Donate', 'reci-media-hub'); ?>
							</span>
						</div>
			...
			<div class="flex-1 flex flex-col gap-10">
				...
				<div id="donation-form" class="w-full p-10 bg-white rounded-lg flex flex-col gap-14 overflow-hidden">
					...
					<div class="flex flex-col gap-10">
						...
						<div class="flex flex-col gap-3">
							<h2 class="text-3xl font-bold font-['EB_Garamond'] text-neutral-800 leading-9">
						...
						<div class="flex flex-col gap-3">
							<h3 class="text-xl font-medium font-['SF_Pro_Display'] text-neutral-800 leading-8 tracking-tight">
						...
						<div id="donation-frequency-row" class="flex flex-col gap-3 hidden">
							...
							<div class="flex gap-3" role="group" aria-label="Donation frequency">
								<button
									...
									class="flex-1 px-4 py-2 bg-amber-400 rounded-lg flex justify-center items-center text-sm font-medium font-['SF_Pro_Display'] text-neutral-800 leading-6 tracking-tight"
									aria-pressed="true">
								...
								<button
									...
									class="flex-1 px-4 py-2 rounded-lg outline outline-[0.5px] outline-neutral-500 flex justify-center items-center text-sm font-medium font-['SF_Pro_Display'] text-neutral-500 leading-5 tracking-tight hover:bg-slate-50 transition-colors"
									aria-pressed="false">
						...
						<div class="flex flex-col gap-3">
							...
							<div class="flex justify-between items-center">
								<h3 id="donation-amount-label" class="text-xl font-medium font-['SF_Pro_Display'] text-neutral-800 leading-8 tracking-tight">
								...
								<div class="flex items-center gap-1">
									...
									<a href="<?php echo esc_url($benefits_url); ?>" class="text-sm font-medium font-['SF_Pro_Display'] text-neutral-500 underline leading-6 hover:text-[#003594] transition-colors">
							...
							<div class="flex flex-col gap-2">
								...
								<div class="relative">
									<span class="absolute left-4 top-1/2 -translate-y-1/2 text-neutral-500 text-sm font-medium font-['SF_Pro_Display']">$</span>
									<input
										type="number"
										...
										class="w-full pl-8 pr-4 py-5 rounded-lg outline outline-[0.5px] outline-zinc-400 text-sm font-normal font-['SF_Pro_Display'] text-neutral-800 placeholder-zinc-400 bg-white focus:outline-[#003594] focus:outline-2 transition-all" />
								</div>
							</div>
					...
					<form
						...
						<div class="flex items-start gap-[5px]">
							...
							<p class="flex-1 text-sm font-normal font-['SF_Pro_Display'] text-neutral-500 leading-6">
