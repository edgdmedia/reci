 ...
 *
 * Displays the Assessments & Learning page with a grid of quiz/assessment cards.
...
$quiz_cards = [
	...
	[
		'title'       => 'Equity Consciousness Assessment',
...
<div class="bg-slate-100 min-h-screen font-['SF_Pro_Display']">
		...
		<div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 xl:px-20 py-14">
			<div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
				<div class="flex items-center gap-3">
					...
					<h1 class="text-neutral-800 text-5xl font-medium font-['EB_Garamond'] leading-tight">
						<?php esc_html_e( 'Check Your Lens', 'reci-media-hub' ); ?>
					</h1>
				</div>
				<div class="lg:pl-10 lg:border-l lg:border-zinc-400">
					<p class="text-neutral-500 text-lg font-normal leading-7 tracking-tight max-w-lg">
						<?php esc_html_e( 'Explore our collection of self-reflection assessments designed to help you understand your own perspectives, biases, and readiness to engage with racial equity.', 'reci-media-hub' ); ?>
					</p>
				</div>
			</div>
		</div>
	...
	<!-- Filter Bar -->
	<div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 xl:px-20 pt-6 pb-5 border-b border-zinc-300">
		<div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
			<div class="flex items-center gap-3">
				<div class="w-72 px-5 py-4 bg-white rounded-lg flex items-center gap-2.5">
					<svg class="w-4 h-4 text-neutral-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-4.35-4.35M17 11A6 6 0 1 1 5 11a6 6 0 0 1 12 0z"/>
					</svg>
					<span class="text-neutral-500 text-base font-light font-['SF_Pro_Display']">
						<?php esc_html_e( 'Search Assessments', 'reci-media-hub' ); ?>
					</span>
				</div>
			</div>
			<div class="flex items-center gap-4">
				<span class="text-neutral-800 text-sm font-medium font-['SF_Pro_Display']">
					<?php esc_html_e( 'Difficulty:', 'reci-media-hub' ); ?>
				</span>
				<div class="flex items-center gap-2">
					<button type="button" class="px-3 py-1.5 bg-[#003594] text-white text-sm rounded font-['SF_Pro_Display']">
						<?php esc_html_e( 'All', 'reci-media-hub' ); ?>
					</button>
					<button type="button" class="px-3 py-1.5 bg-white border border-zinc-300 text-neutral-700 text-sm rounded font-['SF_Pro_Display'] hover:bg-slate-50">
	...
	<div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 xl:px-20 py-10 pb-16">
				...
				<div class="bg-neutral-800 rounded-lg px-10 pt-20 pb-10 flex flex-col justify-between gap-8 min-h-[320px]">
					<div class="flex flex-col gap-5">
						...
						<div class="flex flex-col gap-2.5">
							<h2 class="text-white text-2xl font-semibold font-['EB_Garamond'] leading-7">
								<?php echo esc_html( $quiz['title'] ); ?>
							</h2>
							<p class="text-gray-200 text-sm font-normal font-['SF_Pro_Display'] leading-6">
						...
						<div class="flex items-center gap-4">
							<div class="flex items-center gap-1.5 text-zinc-400 text-xs font-normal font-['SF_Pro_Display']">
							...
							<span class="<?php echo esc_attr( $difficulty_colors[ $quiz['difficulty'] ] ?? 'bg-slate-100 text-slate-600' ); ?> text-xs font-medium px-2 py-0.5 rounded font-['SF_Pro_Display']">
					...
					<!-- CTA -->
						...
						>
							<?php esc_html_e( 'Start Assessment', 'reci-media-hub' ); ?>
						</a>
				</div>
			<?php endforeach; ?>
		</div>
