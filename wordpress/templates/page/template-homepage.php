...
<main>
	...
	<!-- Main  -->
	<div class="reci-container pt-8 lg:pt-10 pb-12 lg:pb-24 flex flex-col lg:flex-row justify-start items-start gap-6 lg:gap-8 xl:gap-10">
	...
	<div class="reci-container-full min-h-[540px] lg:min-h-[750px] py-12 lg:pt-24 lg:pb-14 relative" style="background-image: url('<?php echo esc_url($today_background_image); ?>'); background-size: cover; background-position: center;">
	...
	<div class="reci-container w-full py-10 flex flex-col justify-center items-start gap-8 lg:gap-10">
		<div class=" self-stretch flex flex-row justify-between items-start items-center gap-4 border-b border-zinc-400 pb-8">
			...
			<a href="<?php echo esc_url(get_post_type_archive_link('post') ?: home_url('/articles/')); ?>" class="btn btn-outline-primary btn-sm md:btn-md">View all</a>
		</div>
	...
	<!-- Reflection Gallery -->
	<div class="reci-container-full pt-12 lg:pt-24 pb-10 lg:pb-14 bg-neutral-800/60" style="background-image: url('/wp-content/uploads/2026/03/reflection2.png'); background-size: cover; background-position: center;">
		<div class="reci-container min-h-[540px] lg:min-h-[750px] flex flex-col justify-end items-start gap-8">
			<div data-layer="Frame 1" class="Frame1 self-stretch flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
				<div data-layer="Reflection Gallery" class="ReflectionGallery text-white reci-section-title font-bold">Reflection Gallery</div>
			...
			<div data-layer="Description" class="self-stretch justify-start text-white text-2xl font-normal font-accent leading-10 ">Dive into the Racial Equity Consciousness Institute's Virtual Reflection Gallery – a unique space we've created for you to connect with the stories and perspectives of civil rights leaders and activists.</div>
		</div>
	</div>
	<!-- Videos-->
	...
	<div class=" reci-container py-10 flex flex-col justify-start items-center gap-8 lg:gap-10">
		...
		<div class="-mx-4 sm:-mx-6 lg:-mx-12 xl:-mx-20 self-stretch border-b border-zinc-400 pb-8">
	...
	<div class=" reci-container-full p-12 lg:p-24 bg-white ">
		<div class="reci-container  self-stretch py-10 lg:py-14 bg-slate-100 rounded-lg flex flex-col justify-start items-start gap-8 lg:gap-10">
			<div class="self-stretch flex flex-row justify-between items-center gap-4">
				<div data-layer="Check your lens" class="CheckYourLens text-neutral-800 reci-section-title font-medium">Check your lens</div>
