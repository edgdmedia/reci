					...
					<div class="flex flex-col gap-2">
						...
						<div class="relative">
							<select
								id="reci-city"
								name="reci_city"
								class="w-full appearance-none px-4 py-5 rounded-lg outline outline-[0.5px] outline-zinc-400 text-sm font-normal text-zinc-400 bg-white focus:outline-[#003594] focus:outline-2 transition-all"
							>
