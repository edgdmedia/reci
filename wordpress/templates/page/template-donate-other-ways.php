					...
					<?php foreach ($other_ways as $i => $way) : ?>
						<details class="group" <?php echo $i === 0 ? 'open' : ''; ?>>
							<summary class="flex items-center justify-between gap-4 px-8 py-6 cursor-pointer list-none select-none hover:bg-slate-50 transition-colors">
								...
								<svg class="w-5 h-5 text-neutral-600 shrink-0 transition-transform group-open:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
									<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
								</svg>
							</summary>
							<div class="px-8 pb-8">
								<p class="text-base font-normal text-neutral-600 leading-7  max-w-3xl">
