...
$about_cards = [
    [
        ...
        "icon" => "assets/icons/rocket-launch-outline.svg",
    ],
    [
        "title" => "Our Vision",
        "copy" =>
            "We envision a world where racial equity consciousness is a universal competency — where individuals, communities, and institutions possess the awareness, knowledge, and commitment to dismantle racism and build systems that serve everyone equitably.",
        "icon" => "assets/icons/lightbulb-on-outline.svg",
    ],
    [
        "title" => "Our Approach",
        "copy" =>
            'RECI\'s work is grounded in the metaphor that racism operates as a social virus — and that racial equity consciousness is the vaccine. Through our Structured Cognitive Behavioral Training (SCBT) framework, we guide individuals and organizations through a process-oriented journey of consciousness development across six bilateral spheres. Each sphere represents both an awareness dimension and an action dimension, reflecting the journey from recognition to transformation. This framework has been developed through years of research, tested across multiple cohorts, and is currently supported by NIH-funded research.',
...
$team_items = [
    [
        "id" => 1,
        "name" => "Ron Idoko, M.Ed.",
        "role" => "Founding Director, RECI / Research Assistant Professor, University of Pittsburgh School of Social Work / Associate Director, Center on Race and Social Problems",
        "image_url" => "$template_dir/assets/images/site/team/Ron_Idoko.png",
        "image_alt" => "Ron Idoko, M.Ed.",
        "bio_html" => "
<p>As Associate Director, Ron leads the Center's day-to-day operations and strategic and programmatic initiatives with a focus on research, education, and praxis to advance positive social change. Ron founded and directs the Racial Equity Consciousness Institute, an expansive engagement platform that guides learners &amp; teachers through the critical systems thinking racial equity consciousness framework—via immersive resource modules that integrate narrative guides, videos, activities, articles, reflection prompts, discussion forums, and more—to support learners &amp; teachers in analyzing the complexity and pervasiveness of racism, and reflecting on what they can do, personally and collectively, to catalyze antiracist initiatives, communities, and cultures.</p>
<p>Prior to joining the School of Social Work, Ron worked in the University's Office for Equity, Diversity, and Inclusion (OEDI), where he exercised strategic and programmatic leadership to advance diversity, equity, and inclusion as institutional components of social and academic engagement at the University. Ron is an instructor in the Public Service program at Pitt, facilitating courses that address challenges and opportunities for social equity advancement in the public sector.</p>
<p>He received his Bachelor's and Master's degrees from the University of Pittsburgh and is currently an Ed. D. candidate in the University of Pittsburgh's School of Education.</p>",
    ],
    [
        "id" => 2,
        "name" => "Dr. Alexus Brown",
        "role" => "Senior Social Scientist, Center on Race and Social Problems",
        "image_url" => "$template_dir/assets/images/site/team/Dr_Alexus_Brown.png",
        "image_alt" => "Dr. Alexus Brown",
        "bio_html" => "
<p>Dr. Alexus Brown earned her Ph.D. in Linguistics from the University of Pittsburgh in Spring 2024, specializing in Sociolinguistics, and holds a Bachelor of Arts in English with a minor in Philosophy from Tuskegee University, where she graduated Summa Cum Laude. Her academic work centers on Black language, rhythm, and sociocultural patterns, particularly as expressed in Rap music lyrics—a passion that culminated in her dissertation, \"What's The Deal Forreal: Rap Music's Sociolinguistic Story.\"</p>
<p>Drawn to CRSP by its mission to advance racial equity and social justice through research and education, Alexus is excited to contribute her expertise and creativity to the center's initiatives. A proud Black interdisciplinary sociolinguist and lifelong music enthusiast, she brings a unique perspective that bridges scholarship and cultural appreciation.</p>",
    ],
    [
        "id" => 3,
        "name" => "Oluwafemi Adesanmi MBA, PMP",
        "role" => "Program Manager",
        "image_url" => "$template_dir/assets/images/site/team/oluwafemi_adesanmi.png",
        "image_alt" => "Oluwafemi Adesanmi",
        "bio_html" => "
<p>Oluwafemi Adesanmi is an accomplished Program Manager at CRSP, specializing in Diversity, Equity, and Inclusion (DEI) strategy. With an MBA, a Master's in Information Systems, and over a decade of experience, he excels in leading DEI-focused programs and fostering inclusive growth across various sectors. Known for his strategic vision and operational expertise, Oluwafemi has driven impactful initiatives, including product innovation at the University of Pittsburgh's Center on Race and Social Problems.</p>
<p>His skill set spans data transformation and analytics, technology infrastructure, and Agile frameworks, making him a versatile leader dedicated to advancing CRSP &amp; RECI's mission of transformative, equity-driven change.</p>",
    ],
];
...
$about_community_slides = [
    ...
    [
        "quote" =>
            "The platform makes difficult conversations easier to begin and much more practical to sustain.",
        "author_name" => "Program Participant",
        "author_role" => "Community Partner",
        "author_image" => "https://placehold.co/60x60",
        "author_alt" => "Program Participant",
    ],
];
...
<main class="layout-page">
	...
	<section class="reci-container-full min-h-[500px] relative flex items-center" style="background-image: url('<?php echo esc_url(
     get_template_directory_uri() . "/assets/images/site/about/our-story.webp",
