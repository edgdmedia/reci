...
if (! function_exists('reci_media_hub_default_sdgs')) {
	...
	function reci_media_hub_default_sdgs(): array {
		return [
			['name' => 'No Poverty', 'slug' => 'sdg-1', 'color' => '#E5243B'],
			['name' => 'Zero Hunger', 'slug' => 'sdg-2', 'color' => '#DDA63A'],
			['name' => 'Good Health and Well-being', 'slug' => 'sdg-3', 'color' => '#4C9F38'],
			['name' => 'Quality Education', 'slug' => 'sdg-4', 'color' => '#C5192D'],
			['name' => 'Gender Equality', 'slug' => 'sdg-5', 'color' => '#FF3A21'],
			['name' => 'Clean Water and Sanitation', 'slug' => 'sdg-6', 'color' => '#26BDE2'],
			['name' => 'Affordable and Clean Energy', 'slug' => 'sdg-7', 'color' => '#FCC30B'],
			['name' => 'Decent Work and Economic Growth', 'slug' => 'sdg-8', 'color' => '#A21942'],
			['name' => 'Industry, Innovation and Infrastructure', 'slug' => 'sdg-9', 'color' => '#FD6925'],
			['name' => 'Reduced Inequalities', 'slug' => 'sdg-10', 'color' => '#DD1367'],
			['name' => 'Sustainable Cities and Communities', 'slug' => 'sdg-11', 'color' => '#F99D26'],
			['name' => 'Responsible Consumption and Production', 'slug' => 'sdg-12', 'color' => '#BF8B2E'],
			['name' => 'Climate Action', 'slug' => 'sdg-13', 'color' => '#3F7E44'],
			['name' => 'Life Below Water', 'slug' => 'sdg-14', 'color' => '#0A9BD5'],
			['name' => 'Life on Land', 'slug' => 'sdg-15', 'color' => '#56C02B'],
			['name' => 'Peace, Justice and Strong Institutions', 'slug' => 'sdg-16', 'color' => '#00689D'],
			['name' => 'Partnerships for the Goals', 'slug' => 'sdg-17', 'color' => '#191C7C'],
		];
	}
}
...
add_action('init', 'reci_media_hub_seed_default_sdgs', 23);
...
add_action('init', 'reci_media_hub_seed_default_shows', 22);
