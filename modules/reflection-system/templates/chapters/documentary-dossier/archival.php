		...
		<div class="reci-stage-body">
			<div class="reci-stage-grid lg:grid-cols-[minmax(0,0.9fr)_minmax(360px,1.1fr)] lg:items-start">
				<div class="flex max-h-[70vh] flex-col pr-0 lg:pr-8">
					<div class="reci-scroll-panel !justify-start pr-2">
				...
				<div class="reci-scroll-panel !justify-start max-h-[70vh] rounded-[2rem] border border-[color:var(--reflection-border-soft)] bg-gradient-to-b from-[var(--reflection-card-strong)] to-[var(--reflection-card)] p-6">
								...
								<?php if (! empty($section['links'])) : ?>
									<div class="mt-4 grid gap-3">
										<?php foreach ($section['links'] as $link) : ?>
											<a class="font-semibold reci-reflection-accent no-underline" href="<?php echo esc_url($link['href']); ?>" target="_blank" rel="noopener"><?php echo esc_html($link['label']); ?></a>
										<?php endforeach; ?>
									</div>
								<?php endif; ?>
							</article>
