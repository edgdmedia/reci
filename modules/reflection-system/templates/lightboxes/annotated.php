...
<style>
	...
	#lightbox .lightbox-image-col {
		min-height: 0;
		overflow: hidden;
	}
	#lightbox .lightbox-aside {
		min-height: 0;
		overflow-y: auto;
	}
	.panel-hotspot {
...
<div class="lightbox fixed inset-0 z-[80] hidden place-items-center bg-[color:var(--reflection-overlay)] p-4 sm:p-6" id="lightbox" aria-hidden="true">
	<div class="lightbox-grid relative w-full max-w-[1500px] overflow-hidden rounded-3xl border border-[color:var(--reflection-border)] bg-[var(--reflection-surface-alt)] lg:grid-cols-[minmax(0,1.5fr)_minmax(320px,420px)]">
		...
		<div class="lightbox-image-col relative flex items-center justify-center bg-[var(--reflection-bg)] p-6">
			<img class="block max-h-full max-w-full object-contain" src="" alt="" id="lightboxImage">
			<div class="absolute inset-6" id="hotspotLayer"></div>
		</div>
		<aside class="lightbox-aside border-t border-[color:var(--reflection-border)] bg-[var(--reflection-surface)] p-6 lg:border-l lg:border-t-0">
